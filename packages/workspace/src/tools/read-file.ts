...
export const ReadFile = setupTool({
  ...
  description: dedent`
    ...
    Usage:
    - The ${INPUT_PARAMS.filePath} parameter must be a relative path to a file in the task, or a mount path (/mnt/<name>/..., /skills/..., /connectors/...). E.g. ./${TASK_FOLDER_NAMES.attachments}/upload.txt
