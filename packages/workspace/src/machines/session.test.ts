      ...
      "<session title="Test session" count="6">
        ...
        <assistant finishReason="stop" tokens="13" model="mock-model-id" provider="instrument">
          ...
          <tool tool="read_file" state="output-error" callId="test-call-1">
            ...
            <error>Model tried to call unavailable tool 'invalid_tool_name'. Available tools: connector_credential_prompt, connector_mcp, connector_oauth_prompt, connector_request, connector_test, edit_file, generate_image, load_skill, read_file, bash, web_fetch, web_search, write_file.</error>
          </tool>
        </assistant>
        <assistant finishReason="stop" tokens="13" model="mock-model-id" provider="instrument">
          <step-start step="2" />
