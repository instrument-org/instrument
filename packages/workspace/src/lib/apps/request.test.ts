...
describe("AppManifestSchema baseUrl", () => {
...
describe("AppManifestSchema strictness", () => {
  const base = {
    auth: { kind: "bearer" },
    baseUrl: "https://api.example.com",
    name: "Test",
...
function publicManifest(): ApiAppManifest {
  return {
    auth: { kind: "none" },
    baseUrl: "https://api.example.com",
    name: "Test",
