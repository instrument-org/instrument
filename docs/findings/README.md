...
| [What the task browser reports about itself](task-browser-self-report.md) — where the guest states something untrue about itself, measured; the block that prompted it was a rate limit | open |
