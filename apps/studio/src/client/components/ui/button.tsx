...
export const buttonVariants = tv({
  base: "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg text-sm font-medium whitespace-nowrap transition-[outline] outline-none focus-visible:border-ring focus-visible:outline-[3px] focus-visible:outline-offset-0 focus-visible:outline-ring/50 focus-visible:[outline-style:solid] disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  defaultVariants: {
    size: "default",
    variant: "default",
  },
  variants: {
    size: {
      ...
      xs: "h-6 gap-1.5 rounded-lg px-2.5 text-xs has-[>svg]:px-2 [&_svg:not([class*='size-'])]:size-3",
    },
    variant: {
      brand:
      ...
      "outline-opaque":
        "border border-black/5 bg-background text-muted-foreground not-disabled:hover:bg-secondary dark:border-white/10 dark:not-disabled:hover:bg-gray-800",
      secondary:
