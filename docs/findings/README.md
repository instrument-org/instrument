...
| [What the task browser tells a site about itself](task-browser-automation-surface.md) — the page-side surface behind a reported site block, measured; the block itself is paced, not fingerprinted | open |
