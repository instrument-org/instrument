...
/**
 * The note that wakes an orchestrator: which of its tasks finished a turn, and
 * where to read more. Points at the log rather than inlining it, so a wake
 * costs the same context whether the child wrote one line or a thousand.
 */
