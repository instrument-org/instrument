...
1. Add a named character budget for the model-visible search body. Use 10,000 characters, including excerpt or summary text but excluding the fixed safety preamble and source-title/URL list. The backend caps each excerpt at 3,000 characters and ranks six, so a full search arrives at 18,000 and a budget near that recovers almost nothing: measured against a 13-search session that spent 178,640 characters on excerpts, 16,000 recovers 5.6% and 10,000 recovers 37%. Keep the constant local until another tool has a demonstrated need for the same policy.
