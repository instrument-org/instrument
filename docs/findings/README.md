...
| [What the task browser reports about itself](task-browser-self-report.md) — where the guest states something untrue about itself, measured; the identity half is fixed, and the block that prompted it was a rate limit | partly fixed |
