 ...
 * for every cadence forever. Coming back re-reads the clock and notifies before
 * rescheduling, so the first painted frame is current rather than however stale
 * the window got.
 */
