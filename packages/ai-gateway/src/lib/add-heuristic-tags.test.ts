...
describe("addHeuristicTags", () => {
  const testCases: {
    ...
    { expected: ["coding"], modelId: "gpt-5.5-pro" },
    ...
    { expected: ["coding"], modelId: "gpt-5.6-sol-pro" },
    { expected: ["coding"], modelId: "gpt-5.6-luna-pro" },
    ...
    { expected: ["coding"], modelId: "claude-opus-5-fast" },
