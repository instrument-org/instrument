...
// alphanumeric runs joined with hyphens, truncated at token boundaries. Returns
// an empty string when the prompt has no usable characters (e.g. emoji/CJK only).
