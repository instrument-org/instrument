...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      className={cn(
        "flex field-sizing-content min-h-16 w-full resize-none rounded-xl border-0 bg-linear-to-b from-white to-[#fafaf9] px-3 py-2 text-base shadow-sm transition-[outline] outline-none placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
