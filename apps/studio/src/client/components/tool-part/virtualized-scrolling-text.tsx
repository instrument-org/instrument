...
export function VirtualizedScrollingText({
  ...
  return (
    <div
      className={
        autoScrollToBottom
          ? "pointer-events-none overflow-hidden scroll-fade-y"
          : // scrollbar-hide, not scrollbar-thin: the fade masks the styled
            // scrollbar pill as it nears an edge, so let the fade be the
            // scroll cue instead. The fade signals there is more to see.
            "scrollbar-hide overflow-auto scroll-fade-y"
      }
