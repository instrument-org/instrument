...
// `--available-height` / `--anchor-width` divided by `--content-zoom` so the
// popup's self-applied zoom doesn't double-count them.
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="relative h-full min-w-[calc(var(--anchor-width)/var(--content-zoom))] rounded-lg border bg-popover shadow-lg/5 not-dark:bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]">
            <SelectPrimitive.List
              className={cn(
                "max-h-[calc(var(--available-height)/var(--content-zoom))] overflow-y-auto p-1",
                className,
              )}
