...
const TASK_AGENT_DESCRIPTIONS: Record<TaskAgentName, string> = {
  retrieval: dedent`
    ...
    DO NOT use this agent for files the user uploaded directly to a message -- those are already in the task folder at ${TASK_FOLDER_NAMES.attachments}/ and you can read them directly.
    ...
    When files ARE copied, they are ALWAYS placed in the ${TASK_FOLDER_NAMES.attachments}/ folder. The destination cannot be changed.
